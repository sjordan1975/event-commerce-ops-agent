...
**Immediate next:** re-run browser test to verify commerce routing → test server-side mockup generation (t-shirt + poster paths in `execution.py`) → demo corpus prep (`scripts/prep_demo_corpus.py`), live Shopify/Printful wiring, Cloud Run deploy, demo video. Pre-demo close tasks in `docs/project-close-hygiene.md`. Deadline: June 11, 2026 @ 2:00 PM PDT.
