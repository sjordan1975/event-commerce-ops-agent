...
**Next action: continue demo prep — Phase B (wire the Next.js `ui/` to the real `src/api` backend), then remaining tracks (live Shopify/Printful execution wiring, Cloud Run deploy, demo video). Pre-demo close tasks in `docs/project-close-hygiene.md`.**
