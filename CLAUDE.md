...
**On `step/8-outcomes`. Step 7 merged to `main`. Plan + tasks written (`docs/plans/step-8-outcomes.md`, `docs/tasks/step-8-tasks.md`); branch housekeeping (T-8.0) committed. Next action: implement T-8.1 onward (models → wrappers → capability → register → prompt → Tier-1 eval).**
