...
**Immediate next:** demo corpus prep (`scripts/prep_demo_corpus.py`) — curate the Atlas state that demo runs start from. Then: live Shopify/Printful wiring (swap execution stubs), approval UI, Cloud Run deploy, demo video. Pre-demo close tasks in `docs/project-close-hygiene.md`. Deadline: June 11, 2026 @ 2:00 PM PDT.
