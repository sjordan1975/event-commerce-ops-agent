...
**Step 8 merged to `main`. All 9 capabilities complete. Next action: back-third delivery roadmap (demo corpus, live wiring, approval UI, Cloud Run, demo video) — stub `docs/plans/` roadmap per `project_delivery_roadmap_todo` memory.**
