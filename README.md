...
The live demo is running at **https://event-commerce-ops-agent.vercel.app/** — no installation required.

Paste the following into the chat to run the full pipeline:

```text
France vs Croatia, 2018 FIFA World Cup Final.
France won 4–2 — a dominant victory. Match started 2018-07-15T15:00:00Z. Outcome: expected_win.
